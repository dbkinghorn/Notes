...
enroot start ngc-tf1-10 mpiexec --allow-run-as-root --bind-to socket -np 3 python nvidia-examples/cnn/resnet.py --layers=50 -b 96 --precision=fp32 -i 180 | tee ${OUT_FILE}
